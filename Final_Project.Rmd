...
Here is a link to the source of the dataset we will be using for this tutorial:
...
First, let us get a visualization for the total number of attackers vs non-attackers. We will need to use the group_by() function to group the players who are attackers. Then we use ggplot to get a graphical representation of the data. We will use the geom_col function to represent the two groups.
...
For more help on how to use lm visit this website for an example: 
